...
public class CardFromDB {

    public static void main(String[] args) {
        // РАБОТА С БАЗОЙ ДАННЫХ POSTGRESQL ЧЕРЕЗ JDBC
        try {
            // Адрес нашей базы данных на локальном компьютере (localhost)
            ...
            authorization.put("password", "Qwerty78"); // Зададим пароль доступа в БД
            ...
            ResultSet table = statement.executeQuery("SELECT * FROM card");
